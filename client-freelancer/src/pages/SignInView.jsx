      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-md">
          {step === "credentials" && (<>
              ...
              {/* Google OAuth button */}
              <button type="button" onClick={() => window.location.href = authApi.googleLoginUrl()} className="w-full flex items-center justify-center gap-3 border border-border bg-card hover:bg-muted rounded-xl py-3 px-4 text-sm font-semibold text-foreground transition-colors shadow-sm mb-4 group">
                {/* Google SVG */}
